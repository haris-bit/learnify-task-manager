...
// import sort icon from react icons
    ...
    return (
        <div>
            ...
            >
                Sort by:
                <select
                    className='bg-black border border-gray-400 rounded-lg p-2 shadow-lg cursor-pointer '
                >
            ...
            >
                ...
                >
                    <button className="flex gap-2 bg-gray-900 text-white p-2 rounded-lg shadow-lg mt-4 ml-4 cursor-pointer">
